...
/**
 * StaticResponse service.
 * @module api/StaticResponseApi
 * @version 1.0.0
 */
export default class StaticResponseApi {
  /* eslint-disable sonarjs/no-duplicate-string */

  /**
   * Constructs a new StaticResponseApi.
   * @alias module:api/StaticResponseApi
   * @class
   ...
   */
  getUiServiceAggregationWithHttpInfo() {
    const postBody = null;
   ...
   */
  getUiServiceAggregation() {
    return this.getUiServiceAggregationWithHttpInfo().then(
