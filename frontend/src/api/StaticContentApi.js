 ...
 * @module api/StaticContentApi
 * @version 1.0.0
 */
export default class StaticContentApi {
  /* eslint-disable sonarjs/no-duplicate-string */

  /**
   * Constructs a new StaticContentApi.
   * @alias module:api/StaticContentApi
   * @class
   ...
   */
  getUi() {
    return this.getUiWithHttpInfo().then((responseAndData) => responseAndData.data);
  }
