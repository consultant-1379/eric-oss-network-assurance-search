  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (Object.prototype.hasOwnProperty.call(data, 'metricTypes')) {
        obj.metricTypes = ApiClient.convertToType(data.metricTypes, [MetricType]);
      }
    }
    return obj;
  }
  ...
  static validateJSON(data) {
    ...
    if (data.relations) {
      ...
      if (!Array.isArray(data.relations)) {
        throw new Error(
          `Expected the field \`relations\` to be an array in the JSON data but got ${data.relations}`,
        );
      }
    ...
    if (data.metricTypes) {
      ...
      if (!Array.isArray(data.metricTypes)) {
        throw new Error(
          `Expected the field \`metricTypes\` to be an array in the JSON data but got ${data.metricTypes}`,
        );
      }
