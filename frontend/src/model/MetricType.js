...
class MetricType {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (Object.prototype.hasOwnProperty.call(data, 'visualization')) {
        obj.visualization = MetricTypeVisualization.constructFromObject(data.visualization);
      }
    }
    return obj;
  }
  ...
  static validateJSON(data) {
    ...
    if (!MetricType.jsonStringValidation(data, 'valueType')) {
      throw new Error(
        `Expected the field \`valueType\` to be a primitive type in the JSON string but got ${data.valueType}`,
      );
    }
    // ensure the json data is a string
