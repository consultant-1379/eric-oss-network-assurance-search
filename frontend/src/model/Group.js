...
class Group {
  ...
  static validateJSON(data) {
    ...
    if (!Group.jsonStringValidation(data, 'sort')) {
      throw new Error(
        `Expected the field \`sort\` to be a primitive type in the JSON string but got ${data.sort}`,
      );
    }
    // ensure the json data is a string
    if (!Group.jsonStringValidation(data, 'sortOrder')) {
      throw new Error(
        `Expected the field \`sortOrder\` to be a primitive type in the JSON string but got ${data.sortOrder}`,
      );
    }
