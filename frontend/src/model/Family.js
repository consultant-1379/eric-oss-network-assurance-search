...
class Family {
  ...
  static validateJSON(data) {
    ...
    if (!Family.jsonStringValidation(data, 'subtitle')) {
      throw new Error(
        `Expected the field \`subtitle\` to be a primitive type in the JSON string but got ${data.subtitle}`,
      );
    }
    // ensure the json data is a string
    if (!Family.jsonStringValidation(data, 'unit')) {
      throw new Error(
        `Expected the field \`unit\` to be a primitive type in the JSON string but got ${data.unit}`,
      );
    }
    // ensure the json data is a string
    if (!Family.jsonStringValidation(data, 'widget')) {
      throw new Error(
        `Expected the field \`widget\` to be a primitive type in the JSON string but got ${data.widget}`,
      );
    }
