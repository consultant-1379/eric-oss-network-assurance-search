  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (Object.prototype.hasOwnProperty.call(data, 'families')) {
        obj.families = ApiClient.convertToType(data.families, [Family]);
      }
  ...
  static validateJSON(data) {
    if (data.families) {
      ...
      if (!Array.isArray(data.families)) {
        throw new Error(
          `Expected the field \`families\` to be an array in the JSON data but got ${data.families}`,
        );
      }
    ...
    if (data.groups) {
      ...
      if (!Array.isArray(data.groups)) {
        throw new Error(
          `Expected the field \`groups\` to be an array in the JSON data but got ${data.groups}`,
        );
      }
    ...
    if (data.categories) {
      ...
      if (!Array.isArray(data.categories)) {
        throw new Error(
          `Expected the field \`categories\` to be an array in the JSON data but got ${data.categories}`,
        );
      }
