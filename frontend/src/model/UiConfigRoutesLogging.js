...
/**
 * The UiConfigRoutesLogging model module.
 * @module model/UiConfigRoutesLogging
 * @version 1.0.0
 */
class UiConfigRoutesLogging {
  /**
  ...
  /**
   * Constructs a <code>UiConfigRoutesLogging</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UiConfigRoutesLogging} obj Optional instance to populate.
   * @return {module:model/UiConfigRoutesLogging} The populated <code>UiConfigRoutesLogging</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new UiConfigRoutesLogging();
  ...
  /**
   * Validates the JSON data with respect to <code>UiConfigRoutesLogging</code>.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UiConfigRoutesLogging</code>.
   */
  static validateJSON(data) {
    // ensure the json data is a string
    if (!UiConfigRoutesLogging.jsonStringValidation(data, 'prefix')) {
      throw new Error(
        `Expected the field \`prefix\` to be a primitive type in the JSON string but got ${data.prefix}`,
      );
    }
 ...
 */
UiConfigRoutesLogging.prototype.prefix = undefined;

/**
 * @member {Object} routes
 */
UiConfigRoutesLogging.prototype.routes = undefined;

export default UiConfigRoutesLogging;
