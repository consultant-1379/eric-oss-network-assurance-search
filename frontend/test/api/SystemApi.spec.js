...
(function testingSystemApiApi(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.SystemApi();
  });

  describe('SystemApi', () => {
    describe('getSystemState', async () => {
      it('should call getSystemState successfully', async (done) => {
        await instance.getSystemState();
