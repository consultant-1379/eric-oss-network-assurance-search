...
(function testingStaticResponseApiApi(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.StaticResponseApi();
  });

  describe('StaticResponseApi', () => {
    describe('getUiServiceAggregation', () => {
      it('should call getUiServiceAggregation successfully', (done) => {
        // instance.getUiServiceAggregation().then(
        //  (data) => {
