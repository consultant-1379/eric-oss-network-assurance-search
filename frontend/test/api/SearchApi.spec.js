...
(function testingSearchApiApi(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.SearchApi();
  });

  describe('SearchApi', () => {
    describe('getContextFieldsByQuery', () => {
      it('should call getContextFieldsByQuery successfully', (done) => {
        // instance.getContextFieldsByQuery().then(
        //  (data) => {
    ...
    describe('searchContextFacets', () => {
      it('should call searchContextFacets successfully', (done) => {
        // instance.searchContextFacets().then(
        //  (data) => {
        //    console.log(JSON.stringify(data, null, 4));
        //  },
        //  (error) => {
    ...
    describe('searchMetricsByQuery', () => {
      it('should call searchMetricsByQuery successfully', (done) => {
        // instance.searchMetricsByQuery().then(
        //  (data) => {
        //    console.log(JSON.stringify(data, null, 4));
        //  },
        //  (error) => {
