...
(function testingStaticContentApiApi(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.StaticContentApi();
  });

  describe('StaticContentApi', () => {
    describe('getUi', () => {
      it('should call getUi successfully', (done) => {
        // instance.getUi().then(
        //  (data) => {
