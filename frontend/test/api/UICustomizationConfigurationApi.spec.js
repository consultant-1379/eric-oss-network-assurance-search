...
(function testingUICustomizationConfigurationApiApi(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.UICustomizationConfigurationApi();
  });

  describe('UICustomizationConfigurationApi', () => {
