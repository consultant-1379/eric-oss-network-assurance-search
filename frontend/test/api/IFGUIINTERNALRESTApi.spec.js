...
(function testingIFGUIINTERNALRESTApiApi(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.IFGUIINTERNALRESTApi();
  });

  describe('IFGUIINTERNALRESTApi', () => {
    describe('getUiConfigServiceAggregation', () => {
      it('should call getUiConfigServiceAggregation successfully', (done) => {
        // instance.getUiConfigServiceAggregation().then(
        //  (data) => {
