...
(function testingMetricTypeModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.MetricType();
  });

  describe('MetricType', () => {
    it('should create an instance of MetricType', () => {
      // uncomment below and update the code to test MetricType
      instance = new AssuranceSearchApi.MetricType();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.MetricType);
    });
    ...
    it('should have the property valueType (base name: "valueType")', () => {
    ...
    it('should have the property visualization (base name: "visualization")', () => {
