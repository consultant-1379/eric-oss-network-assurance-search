...
(function testingEntityTypeModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.EntityType();
  });

  describe('EntityType', () => {
    it('should create an instance of EntityType', () => {
      // uncomment below and update the code to test EntityType
      instance = new AssuranceSearchApi.EntityType();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.EntityType);
    });
