...
(function testingFamilyModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.Family();
  });
  ...
  describe('Family', () => {
    it('should create an instance of Family', () => {
      ...
      instance = new AssuranceSearchApi.Family();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.Family);
    });
    ...
    it('should have the property subtitle (base name: "subtitle")', () => {
    ...
    it('should have the property widget (base name: "widget")', () => {
