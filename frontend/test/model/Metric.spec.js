...
(function testingMetricModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.Metric();
  });
  ...
  describe('Metric', () => {
    it('should create an instance of Metric', () => {
      ...
      instance = new AssuranceSearchApi.Metric();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.Metric);
    });
    ...
    it('should have the property beginTimestamp (base name: "beginTimestamp")', () => {
      // uncomment below and update the code to test the property beginTimestamp
      instance = new AssuranceSearchApi.Metric();
      expect(instance).to.not.have.property('placeholder');
    });

    it('should have the property endTimestamp (base name: "endTimestamp")', () => {
      // uncomment below and update the code to test the property endTimestamp
      instance = new AssuranceSearchApi.Metric();
      expect(instance).to.not.have.property('placeholder');
    });

    it('should have the property metadata (base name: "metadata")', () => {
