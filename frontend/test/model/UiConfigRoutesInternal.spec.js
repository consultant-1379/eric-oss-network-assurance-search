...
(function testingUiConfigRoutesInternalModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.UiConfigRoutesInternal();
  });

  describe('UiConfigRoutesInternal', () => {
    it('should create an instance of UiConfigRoutesInternal', () => {
      // uncomment below and update the code to test UiConfigRoutesInternal
      instance = new AssuranceSearchApi.UiConfigRoutesInternal();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.UiConfigRoutesInternal);
    });

    it('should have the property prefix (base name: "prefix")', () => {
