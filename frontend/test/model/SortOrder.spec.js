...
(function testingSortOrderModel(root, factory) {
  factory();
})(this, () => {
  let instance;
  ...
  describe('SortOrder', () => {
    it('should create an instance of SortOrder', () => {
      // uncomment below and update the code to test SortOrder
      instance = new AssuranceSearchApi.SortOrder();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.SortOrder);
    });
  });
});
