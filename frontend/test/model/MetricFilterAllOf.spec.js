...
(function testingMetricFilterAllOfModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.MetricFilterAllOf();
  });

  describe('MetricFilterAllOf', () => {
    it('should create an instance of MetricFilterAllOf', () => {
      // uncomment below and update the code to test MetricFilterAllOf
      instance = new AssuranceSearchApi.MetricFilterAllOf();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.MetricFilterAllOf);
    });
