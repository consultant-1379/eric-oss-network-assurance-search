...
(function testingUiConfigRoutesLoggingModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.UiConfigRoutesLogging();
  });

  describe('UiConfigRoutesLogging', () => {
    it('should create an instance of UiConfigRoutesLogging', () => {
      // uncomment below and update the code to test UiConfigRoutesLogging
      instance = new AssuranceSearchApi.UiConfigRoutesLogging();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.UiConfigRoutesLogging);
    });
