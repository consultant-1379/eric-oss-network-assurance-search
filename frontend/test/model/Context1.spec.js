...
(function testingContext1Model(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.Context1();
  });

  describe('Context1', () => {
    it('should create an instance of Context1', () => {
      // uncomment below and update the code to test Context1
      instance = new AssuranceSearchApi.Context1();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.Context1);
    });
