...
(function testingGetStaticInformation200ResponseInnerModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.GetStaticInformation200ResponseInner();
  });

  describe('GetStaticInformation200ResponseInner', () => {
    it('should create an instance of GetStaticInformation200ResponseInner', () => {
      // uncomment below and update the code to test GetStaticInformation200ResponseInner
      instance = new AssuranceSearchApi.GetStaticInformation200ResponseInner();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.GetStaticInformation200ResponseInner);
    });

    it('should have the property contextType (base name: "contextType")', () => {
      // uncomment below and update the code to test the property contextType
      instance = new AssuranceSearchApi.GetStaticInformation200ResponseInner();
      expect(instance).to.not.have.property('placeholder');
    });

    it('should have the property relations (base name: "relations")', () => {
      // uncomment below and update the code to test the property relations
      instance = new AssuranceSearchApi.GetStaticInformation200ResponseInner();
      expect(instance).to.not.have.property('placeholder');
    });

    it('should have the property metricTypes (base name: "metricTypes")', () => {
