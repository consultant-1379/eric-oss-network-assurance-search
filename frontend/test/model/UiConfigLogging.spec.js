...
(function testingUiConfigLoggingModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.UiConfigLogging();
  });

  describe('UiConfigLogging', () => {
    it('should create an instance of UiConfigLogging', () => {
      // uncomment below and update the code to test UiConfigLogging
      instance = new AssuranceSearchApi.UiConfigLogging();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.UiConfigLogging);
    });

    it('should have the property logLevel (base name: "logLevel")', () => {
