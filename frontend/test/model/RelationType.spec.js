...
(function testingRelationTypeModel(root, factory) {
  factory();
})(this, () => {
  let instance;
  ...
  describe('RelationType', () => {
    it('should create an instance of RelationType', () => {
      // uncomment below and update the code to test RelationType
      instance = new AssuranceSearchApi.RelationType();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.RelationType);
    });
  });
});
