...
(function testingGetContextFieldsByQuery200ResponseModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.GetContextFieldsByQuery200Response();
  });

  describe('GetContextFieldsByQuery200Response', () => {
    it('should create an instance of GetContextFieldsByQuery200Response', () => {
      // uncomment below and update the code to test GetContextFieldsByQuery200Response
      instance = new AssuranceSearchApi.GetContextFieldsByQuery200Response();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.GetContextFieldsByQuery200Response);
    });
