...
(function testingContextTypeModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.ContextType();
  });

  describe('ContextType', () => {
    it('should create an instance of ContextType', () => {
      // uncomment below and update the code to test ContextType
      instance = new AssuranceSearchApi.ContextType();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.ContextType);
    });
    ...
    it('should have the property contextFields (base name: "contextFields")', () => {
      // uncomment below and update the code to test the property contextFields
      instance = new AssuranceSearchApi.ContextType();
      expect(instance).to.not.have.property('placeholder');
    });
  });
