...
(function testingSearchMetricsByQuery200ResponseResultsInnerModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.SearchMetricsByQuery200ResponseResultsInner();
  });

  describe('SearchMetricsByQuery200ResponseResultsInner', () => {
    it('should create an instance of SearchMetricsByQuery200ResponseResultsInner', () => {
      // uncomment below and update the code to test SearchMetricsByQuery200ResponseResultsInner
      instance = new AssuranceSearchApi.SearchMetricsByQuery200ResponseResultsInner();
      expect(instance).to.be.an.instanceOf(
        AssuranceSearchApi.SearchMetricsByQuery200ResponseResultsInner,
      );
    });

    it('should have the property context (base name: "context")', () => {
      // uncomment below and update the code to test the property context
      instance = new AssuranceSearchApi.SearchMetricsByQuery200ResponseResultsInner();
      expect(instance).to.not.have.property('placeholder');
    });

    it('should have the property metrics (base name: "metrics")', () => {
