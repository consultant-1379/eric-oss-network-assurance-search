...
(function testingUiConfigRoutesModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.UiConfigRoutes();
  });

  describe('UiConfigRoutes', () => {
    it('should create an instance of UiConfigRoutes', () => {
      // uncomment below and update the code to test UiConfigRoutes
      instance = new AssuranceSearchApi.UiConfigRoutes();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.UiConfigRoutes);
    });

    it('should have the property internal (base name: "internal")', () => {
