...
(function testingRelationModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.Relation();
  });

  describe('Relation', () => {
    it('should create an instance of Relation', () => {
      // uncomment below and update the code to test Relation
      instance = new AssuranceSearchApi.Relation();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.Relation);
    });

    it('should have the property relationType (base name: "relationType")', () => {
      // uncomment below and update the code to test the property relationType
      instance = new AssuranceSearchApi.Relation();
      expect(instance).to.not.have.property('placeholder');
    });

    it('should have the property related (base name: "related")', () => {
