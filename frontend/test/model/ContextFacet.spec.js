...
(function testingContextFacetModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.ContextFacet();
  });

  describe('ContextFacet', () => {
    it('should create an instance of ContextFacet', () => {
      // uncomment below and update the code to test ContextFacet
      instance = new AssuranceSearchApi.ContextFacet();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.ContextFacet);
    });
