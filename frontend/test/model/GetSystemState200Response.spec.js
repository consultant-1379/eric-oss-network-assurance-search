...
(function testingGetSystemState200ResponseModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.GetSystemState200Response();
  });

  describe('GetSystemState200Response', () => {
    it('should create an instance of GetSystemState200Response', () => {
      instance = new AssuranceSearchApi.GetSystemState200Response();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.GetSystemState200Response);
    });

    it('should have the property status (base name: "status")', () => {
      instance = new AssuranceSearchApi.GetSystemState200Response();
      expect(instance).to.not.have.property('status');
    });

    it('should have the property message (base name: "message")', () => {
      instance = new AssuranceSearchApi.GetSystemState200Response();
      expect(instance).to.not.have.property('message');
    });
  });
});
