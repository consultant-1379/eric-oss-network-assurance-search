...
(function testingMetricTypeVisualizationModel(root, factory) {
  factory();
})(this, () => {
  let instance;

  beforeEach(() => {
    instance = new AssuranceSearchApi.MetricTypeVisualization();
  });

  describe('MetricTypeVisualization', () => {
    it('should create an instance of MetricTypeVisualization', () => {
      // uncomment below and update the code to test MetricTypeVisualization
      instance = new AssuranceSearchApi.MetricTypeVisualization();
      expect(instance).to.be.an.instanceOf(AssuranceSearchApi.MetricTypeVisualization);
    });
