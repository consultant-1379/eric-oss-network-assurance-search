  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (Object.prototype.hasOwnProperty.call(data, 'context')) {
        obj.context = ModelUtil.convertToType(data.context, 'Context');
      }
      if (Object.prototype.hasOwnProperty.call(data, 'metrics')) {
        obj.metrics = ModelUtil.convertToType(data.metrics, [Metric]);
      }
    }
    return obj;
  }
      ...
      if (!Array.isArray(data.metrics)) {
        throw new Error(
          JSON.stringify({
            ...
            message: `Expected the field \`metrics\` to be an array in the JSON data but got ${data.metrics}`,
          }),
        );
      }
