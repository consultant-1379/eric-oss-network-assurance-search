...
class Context {
  ...
  constructor(type, contextFields) {
    Context.initialize(this, type, contextFields);
  }
  ...
  static validateJSON(data) {
    ...
    if (!Context.jsonStringValidation(data, 'id')) {
      throw new Error(
        JSON.stringify({
          customValidationError: true,
          name: 'ModelValidationError',
    ...
    // ensure the json data is a string
    if (!Context.jsonStringValidation(data, 'name')) {
      throw new Error(
        JSON.stringify({
          customValidationError: true,
          name: 'ModelValidationError',
...
Context.RequiredProperties = ['type', 'contextFields'];
 ...
 */
Context.prototype.contextFields = undefined;
