  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (Object.prototype.hasOwnProperty.call(data, 'type')) {
        obj.type = ModelUtil.convertToType(data.type, 'MetricType');
      }
      if (Object.prototype.hasOwnProperty.call(data, 'id')) {
        obj.id = ModelUtil.convertToType(data.id, 'String');
      }
      if (Object.prototype.hasOwnProperty.call(data, 'value')) {
        obj.value = ModelUtil.convertToType(data.value, 'Number');
      }
      if (Object.prototype.hasOwnProperty.call(data, 'beginTimestamp')) {
        obj.beginTimestamp = ModelUtil.convertToType(data.beginTimestamp, 'Number');
      }
      if (Object.prototype.hasOwnProperty.call(data, 'endTimestamp')) {
        obj.endTimestamp = ModelUtil.convertToType(data.endTimestamp, 'Number');
      }
      if (Object.prototype.hasOwnProperty.call(data, 'metadata')) {
        obj.metadata = ModelUtil.convertToType(data.metadata, [MetadataItem]);
      }
    }
    return obj;
  }
      ...
      if (!Array.isArray(data.metadata)) {
        throw new Error(
          JSON.stringify({
            customValidationError: true,
            name: 'ModelValidationError',
            message: `Expected the field \`metadata\` to be an array in the JSON data but got ${data.metadata}`,
          }),
        );
      }
